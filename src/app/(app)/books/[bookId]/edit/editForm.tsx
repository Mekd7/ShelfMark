  ...
  return (
    ...
    <div className="flex flex-col md:h-screen overflow-y-auto">
      ...
      <form action={formAction} className="flex flex-col md:flex-row flex-1">
        ...
        <div className="bg-apricot min-h-[50vh] md:h-full md:flex-1 p-8 flex flex-col items-center justify-center">
          {imagePreview ? (
          ...
          <button
            ...
            className="bg-black text-white py-2 px-4 rounded-[20px] flex gap-2 justify-center items-center mt-12 md:mt-24 shadow-lg transition-transform duration-200 hover:scale-105 hover:bg-gray-800"
          >
        ...
        <div className="flex-1 bg-white p-8 sm:p-12 md:px-24 md:py-32 flex flex-col">
          {/* Book Name */}
          <div>
